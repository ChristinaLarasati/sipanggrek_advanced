...
class AkunSearch extends Akun
{
    ...
    {
        return [
            [['username', 'password', 'nik_anggota', 'id_petugas', 'peran_pengguna'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'username', $this->username])
            ...
            ->andFilterWhere(['like', 'nik_anggota', $this->nik_anggota])
            ->andFilterWhere(['like', 'id_petugas', $this->id_petugas])
            ->andFilterWhere(['like', 'peran_pengguna', $this->peran_pengguna]);
